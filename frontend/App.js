...
function HomeScreen({ navigation }) {
  ...
  return (<ScrollView style={[styles.container,{backgroundColor:theme.bg}]}>
    ...
    <View style={styles.menuGrid}>
      ...
      <TouchableOpacity style={[styles.menuItem,{backgroundColor:theme.card}]} onPress={()=>navigation.navigate('Check')}><Text style={styles.menuIcon}>✅</Text><Text style={[styles.menuText,{color:theme.text}]}>Verifica</Text></TouchableOpacity>
      <TouchableOpacity style={[styles.menuItem,{backgroundColor:theme.card}]} onPress={()=>navigation.navigate('NumberMeaning')}><Text style={styles.menuIcon}>🔢</Text><Text style={[styles.menuText,{color:theme.text}]}>Significato</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  actionRow:{flexDirection:'row',margin:15,gap:10},refuseButton:{flex:1,backgroundColor:'#f44336',padding:18,borderRadius:12,alignItems:'center'},acceptButton:{flex:1,backgroundColor:'#4caf50',padding:18,borderRadius:12,alignItems:'center'},
  ...
  titleSmall:{fontSize:22,fontWeight:'300',color:'#fff'},subtitle:{fontSize:14,color:'#b3b3b3',marginTop:10},
