...
function AnalysisScreen({ navigation }) {
  ...
  const performAnalysis = async () => {
    ...
    try {
      ...
      Alert.alert('Errore', 'Impossibile completare l\'analisi. Riprova più tardi.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      <View style={styles.analysisHeader}>
        ...
        <Text style={styles.description}>
          L'algoritmo analizza tutti i 90 numeri usando 14 fattori statistici
          e genera le migliori 10 sestine consigliate.
        </Text>
      </View>
    ...
    <NavigationContainer>
      ...
      >
        <Stack.Screen 
          ...
          options={{ title: 'SuperEnalotto Analyzer' }}
        />
        <Stack.Screen 
          name="Analysis" 
          component={AnalysisScreen}
          options={{ title: 'Analisi' }}
        />
        <Stack.Screen 
          name="Results" 
